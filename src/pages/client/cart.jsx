    ...
    return(
        <div className="w-full h-full flex flex-col items-center pt-4 relative">
            <div className="w-[400px] h-[80px] shadow-2xl absolute bottom-1 md:top-1 right-1 flex flex-col justify-center items-center">
                    ...
                    } className= "text-white bg-accent px-4 py-2 rounded-lg font-bold hover:bg-secondary cursor-pointer transition-all duration-300">
                    Checkout
                    </Link>
            </div>
            {
                    ...
                    (item)=>{
                        return(
                            ...
                            <div className="max-w-[100px] w-[100px]  h-full flex flex-row justify-evenly items-center">
                                <button className="text-white font-bold hover:bg-secondary text-xl cursor-pointer aspect-square bg-accent rounded-xl p-2" onClick={()=>{
                                    addToCart(item ,-1)
                                    setCart(getCart())
                                }}><BiMinus/></button>
