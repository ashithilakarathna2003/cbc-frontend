                    ...
                    (item)=>{
                        return(
                            ...
                            <div className="max-w-[100px] w-[100px]  h-full flex flex-row justify-evenly items-center">
                                <button className="text-white font-bold hover:bg-secondary text-xl cursor-pointer aspect-square bg-accent rounded-xl p-2"><BiMinus/></button>
                                <h1 className="text-xl text-secondary font-semibold h-full flex items-center">{item.qty}</h1>
                                <button className="text-white font-bold hover:bg-secondary text-xl cursor-pointer aspect-square bg-accent rounded-xl p-2"><BiPlus/></button>
